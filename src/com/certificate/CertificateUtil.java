...
public class CertificateUtil {
	...
	public static CertificateDetails getCertificateDetails(String jksPath, String jksPassword) {
		...
		try {
			...
			KeyStore keyStore = KeyStore.getInstance("PKCS12");//"JKS"
			...
			if (isAliasWithPrivateKey) {
				...
				// Get certificate of public key
			      ...
			      certDetails.setPublicKey(publicKey);
	...
	public static PublicKey getPublicKey(String jkspath,String jkspassword) {
		FileInputStream fin;
		try {
			fin = new FileInputStream("PathToCertificate");
